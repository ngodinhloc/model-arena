...
class Container:
    ...
    def score_service(self) -> ScoreService:
        return ScoreService(self.experiment_manager, self.rabbitmq_publisher, self.logger("score_service"))

    @cached_property
    def experiment_event_handler(self) -> ExperimentEventHandler:
        return ExperimentEventHandler(self.score_service, self.logger("experiment_event_handler"))
