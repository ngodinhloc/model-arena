...
import { ExperimentEvent, AgentStatus, Message, EVENT_EXPERIMENT_CREATED, SCORE_CARD_NAMES, SCORE_CARD_MAX_POINT } from 'src/experiment/contracts/experiment.interface';

export class ExperimentEventBuilder {
    static build(experiment: Experiment, messages: Message[], agentStatus: AgentStatus): ExperimentEvent {
        return {
