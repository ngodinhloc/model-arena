...
import { CandidateConfig, JudgeConfig } from "src/experiment/contracts/experiment.interface";
...
export class ExperimentRepository {
    ...
    async new(category: string, topic: string, rounds: number, candidateConfig: CandidateConfig[], judgeConfig: JudgeConfig[]): Promise<Experiment> {
